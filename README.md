...
本项目是 **疫情隔离管理系统**，采用主流 Java Web 技术栈开发，功能完整、结构清晰，非常适合作为毕业设计或课程设计的参考源码。

**仓库名**：`java-project-168-springboot-vue-qing-ge-li-guan-li`

**原始压缩包名**：`springboot168基于springboot + vue的疫情隔离管理系统`
